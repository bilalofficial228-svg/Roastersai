...
const LANGUAGE_DIRECTIONS: Record<Language, string> = {
  ...
  hindi:
    "Generate roast in HINDI language ONLY, written in DEVANAGARI script (हिन्दी). 100% Hindi — ZERO English words, ZERO Roman script, ZERO Hinglish. Use simple everyday Hindi that everyone understands. Be funny through Bollywood references, desi family pressure, city life humor, and relatable Indian cultural observations. Use natural Hindi wordplay and punchlines. Example good Hindi: 'बिलाल, इंजीनियर बन गए 💀 / पर बग fix करते करते / अपनी ज़िंदगी का code ही crash हो गया 😂'. MAX 3 lines, one killer punchline at end. Screenshot worthy!",
  spanish:
  ...
  urdu:
    "Generate roast in URDU language ONLY, written in proper Urdu Nastaliq script (اردو). Every single word must be in Urdu Arabic script — ZERO Roman letters, ZERO English words. Use simple everyday Urdu that anyone understands — not formal/literary Urdu. Be funny through Pakistani cultural references: family pressure, rishta drama, career struggles, neighbor aunty gossip, city life (Karachi traffic, Lahore smog, Islamabad attitude). Use natural Urdu wordplay and humor that hits like a punch. Example good Urdu: 'ہونا، امریکا میں ڈاکٹر بن گئی 💀 / لیکن اپنی زندگی کا نسخہ ابھی تک غلط ہے / مریض تو ٹھیک ہو جاتے ہیں، تیری قسمت کا علاج نہیں 😂'. MAX 3 lines, one killer punchline at end. Screenshot worthy!",
};

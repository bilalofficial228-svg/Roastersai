...
const LANGUAGE_DIRECTIONS: Record<Language, string> = {
  ...
  hindi:
    "Generate roast in HINDI language ONLY, written EXCLUSIVELY in DEVANAGARI script — क, ख, ग, घ. ZERO Roman letters, ZERO English words anywhere. NEVER write 'Bhai', always write 'भाई'. NEVER write 'Yaar', always write 'यार'. NEVER write the person's name in Roman — transliterate to Devanagari: 'Komal'→'कोमल', 'Ahmed'→'अहमद', 'Sara'→'सारा', 'John'→'जॉन'. STRICT STRUCTURE — 3 lines MAX: Line 1 = NAME (Devanagari) + CITY + JOB joke. Line 2 = weakness or life situation with Bollywood/Indian cultural humor. Line 3 = punchline about single/relationship status. 2-3 emojis naturally inside sentences. JOB-specific jokes: Doctor→'मरीज ठीक करती है पर खुद की किस्मत नहीं', Engineer→'कोड में bugs नहीं, जिंदगी में हैं', Student→'पढ़ाई कम Netflix ज्यादा'. Bollywood refs like SRK, DDLJ okay. FRIENDLY example: 'कोमल, लाहौर में डॉक्टर हो — बहुत अच्छी बात! 😄 / मरीजों को ठीक करो, खुद की जिंदगी भी संभालो 😂 / सही बंदा आएगा जरूर, बस थोड़ा इंतजार करो! ✅'. SAVAGE example: 'कोमल, लाहौर में डॉक्टर हो / पर अपनी जिंदगी का इलाज नहीं कर पाती 💀 / मरीज ठीक हो जाते हैं, तेरी किस्मत का नुस्खा अभी गलत है 🔥'. DARK example: 'कोमल, डॉक्टर बन गई / पर जिंदगी का सिलेबस अभी भी फेल है 🌑 / लाहौर की सड़कों से ज्यादा तेरी किस्मत अंधेरे में है 💀'. DESI example: 'कोमल बेटा, पूरे मोहल्ले को पता है / लाहौर में अभी तक अकेली हो 😭 / अम्मी रोज रिश्ता पूछती हैं, तू रोज Netflix चलाती है 🔥💀'. Screenshot worthy — person must laugh reading it!",
  spanish:
  ...
  roman_urdu:
    "Generate roast in ROMAN URDU ONLY — written entirely in English/Roman alphabet. ZERO Urdu script letters. Write exactly like Pakistanis text on WhatsApp: natural mix of Urdu words in Roman letters with English. MANDATORY Pakistani words: yaar, bhai, baji, mohalla, ammi, aunty, rishta, jugaar, load shedding, shaadi, padhai, zindagi, hai, lekin, isliye, kyunki, toh, aur, tera/teri. STRICT STRUCTURE — 3 lines MAX: Line 1 = NAME + CITY + JOB/STUDY reference. Line 2 = weakness or life situation with Pakistani cultural humor. Line 3 = killer punchline about single/relationship status with aunty/rishta/shaadi angle. 2-3 emojis naturally inside sentences. EVERY sentence must be funny and specific. FRIENDLY example: 'Komal yaar, Lahore mein student hai to koi baat nahi / teri mehnat rang laayegi thoda kam Netflix toh sahi 😄😂 / Single hai but sahi banda aa jaayega zaroor ✅'. SAVAGE example: 'Komal, Lahore ki student ho lekin / teri degree ka future load shedding jaisa dark hai 💀 / Single isliye hai kyunki commitment tujhse zyada teri Netflix subscription ne ki 😂🔥'. DARK example: 'Komal, Lahore mein padhti ho lekin / zindagi ka syllabus abhi clear nahi 🌑 / Single isliye ki log tera future dekh ke seedha dost zone mein jaate hain 💀'. DESI example: 'Komal baji, puri mohalle ko pata hai / Lahore mein abhi tak single ho 😭 / Ammi roz rishta poochti hai aur tu roz Netflix chalati hai 🔥'. Always screenshot worthy — specific, Pakistani, and hilarious!",
};

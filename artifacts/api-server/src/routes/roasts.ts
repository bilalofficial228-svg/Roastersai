...
const LANGUAGE_DIRECTIONS: Record<Language, string> = {
  ...
  arabic:
    "Generate roast in ARABIC language ONLY, written in Arabic script (RTL). 100% Arabic — ZERO English words or Roman letters or Japanese or any other non-Arabic script. CRITICAL: The person's NAME must ALWAYS be written in Arabic script letters — transliterate it: 'Osama'→'أوسامة', 'Ali'→'علي', 'Sara'→'سارة', 'John'→'جون', 'Mike'→'مايك'. NEVER write names in Latin, Japanese, or any non-Arabic script. Use simple colloquial Arabic that everyone understands. STRICT STRUCTURE — 3 lines MAX: Line 1 = NAME (in Arabic script) + CITY reference + JOB mention. Line 2 = weakness or job joke with CITY flavor. Line 3 = crystal clear punchline about their relationship/single status ONLY — simple words, easy to understand, must make anyone laugh immediately. MANDATORY: NAME in Line 1. CITY in Line 1 or 2. JOB always mentioned. Line 3 MUST be about single/relationship status with simple vocabulary. GOOD Line 3 example: 'وما زلت أعزب لأن حتى الواي فاي عنده اتصالات أكثر منك 😂'. BAD Line 3 (never do this): confusing metaphors or philosophical sentences. 2-3 emojis placed INSIDE sentences. Simple clear words — no confusing metaphors. FRIENDLY example: 'أوسامة، مؤثر في أمريكا / لكن محتوى فيديوهاتك خفيف مثل ريح الصحراء 😄 / لا بأس، يوماً ما ستجد شخصاً يشاهدك 😂'. SAVAGE example: 'أوسامة، تدّعي أنك مؤثر / لكن في أمريكا ما أحد يعرفك حتى 💀 / محفظتك فارغة مثل قناتك على يوتيوب 🔥'. DARK example: 'أوسامة، تعيش في أمريكا / لكن حياتك أظلم من ليل الصحراء 🌑 / المشاهير يتركون أثراً، أنت تترك فقط ديوناً 💀'. DESI example: 'أوسامة، كل الحارة تعرف / إنك لسا عازب في أمريكا 😭 / أهلك يسألون متى تتزوج وأنت تسأل متى يجي الأكل 🔥'. Always funny, always clear, always screenshot worthy!",
  french:

...
const LANGUAGE_DIRECTIONS: Record<Language, string> = {
  ...
  urdu:
    "Generate roast in URDU language ONLY, written in proper Urdu Nastaliq script (اردو). Every word must be in Urdu Arabic script — ZERO Roman letters, ZERO English words. Simple everyday Pakistani Urdu — NOT formal or literary. Every sentence must make clear sense. STRICT STRUCTURE: Line 1 = NAME + CITY + JOB joke, Line 2 = CITY reference + weakness/status, Line 3 = killer punchline. Always mention CITY and NAME multiple times. 2-3 emojis placed inside sentences. MAX 3 lines. NEVER confusing sentences, NEVER weak endings, NEVER missing the city. Style-specific tone: FRIENDLY→warm light teasing like a friend, end with 😄 or 😂, person feels good. SAVAGE→no mercy brutal truth, stings but funny, end with 💀 or 🔥. DARK→existential life choices burn, dark but not depressing, end with 🌑 or 💀. DESI→family/society pressure, aunty/rishta/log kya kahenge angle, end with 😭 or 🔥. Examples — FRIENDLY: 'انجم، بینکاک میں اکاؤنٹنٹ ہو / محنتی ہو لیکن اپنی زندگی کا حساب ٹھیک کرو 😄 / صحیح بندی آئے گی ضرور 😂'. SAVAGE: 'انجم، بینکاک میں اکاؤنٹنٹ ہو / محبت کا حساب ہمیشہ منفی میں رہتا ہے 💀 / spreadsheet میں بیوی کا خانہ خالی ہے 🔥'. DARK: 'انجم، بینکاک کی گرمی میں بھی تیری قسمت ٹھنڈی ہے 🌑 / حساب کتاب سب جانتے ہو / بس اپنی زندگی کا خسارہ نظر نہیں آتا 💀'. DESI: 'انجم بھائی، پوری گلی کو پتہ ہے بینکاک میں اکاؤنٹنٹ ہو 😭 / امی نے محلے کی آنٹی کو بتا دیا ابھی تک اکیلے ہو 🔥 / رشتہ آنے سے پہلے حساب ٹھیک کرو 💀'. BAD (never do this): confusing repetitive sentences. Screenshot worthy!",
};

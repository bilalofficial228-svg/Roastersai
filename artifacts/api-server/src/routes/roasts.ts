...
const LANGUAGE_DIRECTIONS: Record<Language, string> = {
  ...
  urdu:
    "Generate roast in URDU language ONLY, written in proper Urdu Nastaliq script (اردو). Every single word must be in Urdu Arabic script — ZERO Roman letters, ZERO English words. Tone: simple Pakistani Urdu like how Pakistanis talk daily — NOT formal or literary Urdu, simple clear words only. Always use the person's NAME, CITY, and JOB with irony. Use Pakistani references: cricket, load shedding, rishta drama, family pressure, city life. 2-3 emojis placed inside sentences. GOOD example: 'انجم، تھائی لینڈ میں اکاؤنٹنٹ ہے / لیکن محبت کا حساب منفی ہے 💀 / اکیلے اس لیے کہ spreadsheet میں بیوی کا خانہ خالی ہے 😂'. BAD (never do this): confusing repetitive sentences like 'انجنئر انجم ہیں انجم انجنئر'. MAX 3 lines, clear funny punchline at end. Screenshot worthy!",
};

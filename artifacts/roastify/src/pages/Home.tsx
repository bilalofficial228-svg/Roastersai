                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed opacity-85">
                      English, Hindi, Urdu, Arabic, Spanish, French, German, (Brazil), and Japanese — because everyone deserves to be roasted in their mother tongue.
                    </p>
                  </div>
                  <div>
            ...
            <InfoModal
              ...
              content={
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-primary mb-1">Cookies & Local Storage</h3>
                    <p className="text-sm leading-relaxed opacity-85">
